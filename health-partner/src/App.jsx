...
function App() {
  ...
  return (
    <BrowserRouter>
      ...
      */}
      {user && window.location.pathname !== "/marketplace" && (
        <div className="fixed bottom-6 right-6 z-50 animate-bounce">
          <button 
           onClick={() => window.location.href='/marketplace'}
           className="bg-red-600 hover:bg-red-700 text-white p-4 rounded-full shadow-2xl flex items-center gap-2 group transition-all"
          >
