const HospitalCard = ({ hospital }) => {
  return (
    <div className="bg-white rounded-xl shadow-lg border border-indigo-100 overflow-hidden hover:shadow-xl transition-all">
      {/* Header */}
      <div className="bg-gradient-to-r from-teal-400 to-purple-500 px-6 py-4">
      ...
      <div className="p-6">
        ...
        <div className="flex gap-2 mt-4">
          ...
          <button className="px-4 py-2 border border-teal-100 rounded-lg hover:bg-teal-50 transition-colors text-indigo-700">
            📋 Details
          </button>
        </div>
      </div>
