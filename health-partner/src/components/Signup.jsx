        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 outline-none transition-all text-gray-700 font-medium"
            >
          ...
          <button
            type="submit"
            className="w-full mt-2 py-4 bg-purple-600 text-white rounded-xl hover:bg-purple-700 font-extrabold shadow-md transition-all active:scale-95"
          >
